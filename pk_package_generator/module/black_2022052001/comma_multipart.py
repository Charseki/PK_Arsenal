...
class comma_multipart:
    ...
    def generate_packages(self, amount):
        ...
        self.common.multipart_exp = '----WebKitFormBoundary{}'.format(''.join(
            random.sample(string.ascii_letters + string.digits, random.randint(4, 10))))
        self.common.content_type_exp = 'Content-Type: multipart/form-data; boundary={},'.format(
